...
public class NetworkSwitcherDialog extends DialogFragment {
    ...
    private @NetworkType.Type int selectedNetwork;

    public static NetworkSwitcherDialog getInstance() {
        return new NetworkSwitcherDialog();
    }

    public NetworkSwitcherDialog setOnNetworkListener(final OnItemClickListener<Integer> listener) {
    ...
    private void initRecyclerView() {
        ...
        final NetworkAdapter adapter = new NetworkAdapter(getNetworkList())
    ...
    private List<String> getNetworkList() {
        ...
        networks.add(getString(R.string.ropsten_testnet_staging));
        networks.add(getString(R.string.ropsten_testnet));
        networks.add(getString(R.string.mainnet));
        return networks;
    }

    private void handleNetworkClicked(final @NetworkType.Type int network) {
